      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="w-44 aspect-[4/5] sm:w-48 md:w-60 bg-dark-surface rounded-2xl border border-dark-border flex items-center justify-center overflow-hidden shadow-lg shadow-black/10">
              <img
                src="/yash_pfp.png"
                alt="Yash Raj"
